...
function extractArticleDateTime($) {
    ...
    const possibleDateSelectors = [
        ...
        "meta[property='article:published_time']", // Meta tag for published time
        "meta[name='pubdate']", // Meta tag for publication date
        "meta[name='date']", // General date meta tag
        "meta[itemprop='datePublished']", // Schema.org date
        "div[class*='date']", // Divs that may contain date
        "span[class*='date']", // Spans that may contain date
    ];
...
//# sourceMappingURL=summarizerController.js.map