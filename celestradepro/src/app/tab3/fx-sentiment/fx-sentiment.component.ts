...
@Component({
  selector: 'app-fx-sentiment',
  templateUrl: './fx-sentiment.component.html',
  styleUrls: ['./fx-sentiment.component.scss'],
})
export class FxSentimentComponent implements OnInit {
